...
```math
G(t)=\frac{V}{kBT}\left(\frac{<N_{xy}(0) N_{xy}(t)>+<N_{yz}(0)N_{yz}(t)>+<N_{xz}(0)N_{xz}(t)>}{30}+\frac{<\sigma_{xy}(0)\sigma_{xy}(t)>+<\sigma_{yz}(0)\sigma_{yz}(t)>+<\sigma_{xz}(0)\sigma_{xz}(t)>}{5}\right)
```
```math
